...
window.onload = function(){
  ...
  function initializeGrid(imageArray){
    ...
    var tid = setInterval(function (){
      ...
      else if(loadedImages == imageArray.length || deltaTime >= 1000){
        clearInterval(tid);
